...
LIB_FILE="/home/yyan/vlc/examples/galois/lib/Galois/build/libgalois/libgalois_shmem.so"
...
rm -f address.* bfs_launcher_vlc_transparency *.init.c *.tramp.S *.ver vlc_callback.c vlc_hashmap.c vlc_hashmap.h

make bfs_launcher_vlc_transparency
time LD_LIBRARY_PATH=. ./bfs_launcher_vlc_transparency
